  ...
  <p>
    ...
    <details>
      ...
      <ol>
        ...
        <li><strong>One-click install:</strong> Click this link to Install Wplace.live Enable Reporting directly: <a href="https://github.com/Alarisco/wplace-enable-reporting/releases/download/1.0/EnableReporting.user.js" target="_blank" rel="noopener noreferrer"><strong>Install Wplace.live Enable Reporting</strong></a>
        <br>
    ...
    <details>
      ...
      <ol>
        ...
        <li><strong>One-click install:</strong> Click this link to Install Wplace.live Enable Reporting directly: <a href="https://github.com/Alarisco/wplace-enable-reporting/releases/download/1.0/EnableReporting.user.js" target="_blank" rel="noopener noreferrer"><strong>Install Wplace Enable Reporting</strong></a>
        <br>
        TamperMonkey will automatically detect the userscript and prompt you to install it.</li>
        <li>Refresh the <a href="https://wplace.live/" target="_blank" rel="noopener noreferrer">wplace.live</a> webpage.</li>
      </ol>
