<h1>wplace-enable-reporting</h1>
<p>Enable Wplace.live reporting for people who aren't in the A/B test</p>

<p>Credits to <a href="https://github.com/SwingTheVine/Wplace-BlueMarble">Blue Marble</a> for their fetch snippet and install guide</p>
...
<h3>Installation Instructions</h3>
  ...
  <p>
    <br>
    Installation instructions for Wplace Enable Reporting are below. Click the arrows to expand the instructions you want to see. Blue text is a link.
    <details>
      <summary>
      ...
      <ol>
        ...
        <li><strong>One-click install:</strong> Click this link to Install Wplace.live Enable Reporting directly: <a href="https://github.com/yeeterlol/wplace-enable-reporting/releases/download/1.0.0/EnableReporting.user.js" target="_blank" rel="noopener noreferrer"><strong>Install Wplace.live Enable Reporting</strong></a>
        <br>
    ...
    <details>
      ...
      <ol>
        ...
        <li>Download the <a href="https://github.com/yeeterlol/wplace-enable-reporting/releases" target="_blank" rel="noopener noreferrer">EnableReporting.user.js</a> file in the "Assets" of the latest release.</li>
        ...
        <li>Drag the <code>EnableReporting.user.js</code> file inside the dashboard of TamperMonkey.
        <br>
        ...
        <li>Click the "Install" button to Install Wplace Enable Reporting.
        <br>
        ...
        <li>Enable Wplace.live Enable Reporting inside the TamperMonkey dashboard.
        <br>
    ...
    <details>
      ...
      <ol>
        ...
        <li><strong>One-click install:</strong> Click this link to Install Wplace.live Enable Reporting directly: <a href="https://github.com/yeeterlol/wplace-enable-reporting/releases/download/1.0.0/EnableReporting.user.js" target="_blank" rel="noopener noreferrer"><strong>Install Wplace Enable Reporting</strong></a>
        <br>
        TamperMonkey will automatically detect the userscript and prompt you to install it.</li>
        <li>Refresh the <a href="https://wplace.live/" target="_blank" rel="noopener noreferrer">wplace.live</a> webpage.</li>
      </ol>
